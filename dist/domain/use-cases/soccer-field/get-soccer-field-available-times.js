...
class GetSoccerFieldAvailableTimes {
    static execute(id, month) {
        return __awaiter(this, void 0, void 0, function* () {
            const registredSoccerField = yield GetSoccerFieldAvailableTimes.repository.findById(id);
            return registredSoccerField === null || registredSoccerField === void 0 ? void 0 : registredSoccerField.getAvailableTimes(month);
        });
    }
}
