...
(0, vitest_1.describe)('Testes relacionados ao Time', () => {
    ...
    (0, vitest_1.it)('Verificar se as informações do jogador foram editadas', () => {
        ...
        (0, vitest_1.expect)(updatedPlayer === null || updatedPlayer === void 0 ? void 0 : updatedPlayer.name).equals('João Silva');
        (0, vitest_1.expect)(updatedPlayer === null || updatedPlayer === void 0 ? void 0 : updatedPlayer.stars).equals(5);
    });
