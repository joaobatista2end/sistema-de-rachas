...
describe('Testes relacionados ao Time', () => {
    it('Verificar se os jogadores foram adicionados ao time', () => {
      const player1 = new Player({ name: 'João', stars: 2 });
      const player2 = new Player({ name: 'Carlos', stars: 3 });
      const team = new Team({ name: 'Os Incríveis', players: [player1] });
    ...
    it('Verificar se os jogadores foram removidos do time', () => {
      const player1 = new Player({ name: 'João', stars: 2 });
      const player2 = new Player({ name: 'Carlos', stars: 3 });
      const team = new Team({ name: 'Os Incríveis', players: [player1, player2] });
    ...
    it('Verificar se as informações do jogador foram editadas', () => {
      ...
      const team = new Team({ name: 'Os Incríveis', players: [player] });
